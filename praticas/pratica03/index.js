...
function FormLogin() {
    ...
    const inputSenha = Input("email", "password", "Senha");
    const inputSubmit = InputSubmit("Entrar");
    form.append(inputEmail, inputSenha, inputSubmit);
...
function Cabecalho() {
    ...
    const icone = Icone("https://www.svgrepo.com/show/507851/search-square.svg", "Icone de Pesquisar");
